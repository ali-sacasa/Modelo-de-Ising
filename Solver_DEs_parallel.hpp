#ifndef HPP_SOLVER_DES_HPP
#define HPP_SOLVER_DES_HPP
...
public:
    ...
    int num_threads;  // Número de threads OpenMP
...
public:
    ...
    static MatrixXcd compute_local_energy_density(
        const MatrixXcd& states, 
...
public:
    ...
    // Guardar matriz 2D
    static void save_matrix_csv(const Eigen::MatrixXd& data,
                               const std::string& filename,
                               const std::string& header = "");
    
    // Guardar matriz compleje 2D
    static void save_complex_matrix_csv(const Eigen::MatrixXcd& data,
                                       const std::string& filename,
                                       const std::string& header = "");
